    ...
    <div className="relative min-h-screen">
        <div className="pb-20 pt-20 lg:pt-30 lg:pb-30">
            <div className="flex flex-col lg:flex-row justify-center items-center relative my-12 z-10 gap-24">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col p-0">
                    <div className="mb-14">
                        <TextGenerateEffect
                    ...
                    <div className="mt-16">
                        <FadingText
                            className="text-center justify-center items-center md:tracking-wider text-sm md:text-md lg:text-[18px]"
                            delay={0.2}
                        />
                    </div>
                </div>
